jQuery(function($) {
	...
	function showTestFields( action ) {
		...
		var fileUploadField = '<div id="fileUploadField" class="form-group"><label class="col-md-4 control-label" for="fileUpload">File to Upload</label><div class="col-md-4"><input id="fileUpload" name="fileUploadField" class="input-file" type="file"></div></div>';
		clearTestFields();
		switch (action) {
